...
namespace Support
{
    ...
    internal class Protector
    {
        ...
        {
			Game.PrintChat("<font color=\"#00BFFF\">====== |鎴愬姛杞藉叆锛氬叏杈呭姪鍚堥泦| ======</font>");
			Game.PrintChat("<font color=\"#00BFFF\">====== 鍖呭惈鑻遍泟====== </font>");
			Game.PrintChat("<font color=\"#00BFFF\">|鐗涘ご|鏈哄櫒浜簗甯冮殕|鏈棩|鏇欏厜|椋庡コ|澶╁惎鑰厊闇查湶|鑾敇濞渱濞滅編|鐞村コ|瀹濈煶|閿ょ煶|鏃跺厜|濠曟媺|</font>");
			Game.PrintChat("<font color=\"#00BFFF\">|鏇村L#璧勮璇疯闂畖锛殀L#涓枃绀惧尯|www.loll35.com</font>");
            Menu = new Menu("Support: 瀹樻柟璁哄潧", "Protector", true);
